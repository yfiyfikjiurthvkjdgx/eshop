      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
            <h1>Welcome to e-shop.com</h1>
            <p>Oure team of experts will help you realize your vision</p>
            <div class="d-flex">
              <a href="index.html#about" class="btn-get-started">Welcome</a>
              <a href="https://www.youtube.com/watch?v=Y7f98aduVJ8" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Product Video</span></a>
            </div>
          </div>
